...
import org.firstinspires.ftc.teamcode.configuration.MecanumDriveConstants
...
@Config
class MecanumDrive(hardwareMap: HardwareMap, @JvmField var pose: Pose2d) {
    ...
    init {
        ...
        leftFront = hardwareMap.get(DcMotorEx::class.java, PARAMS.leftFrontName)
        leftBack = hardwareMap.get(DcMotorEx::class.java, PARAMS.leftBackName)
        rightBack = hardwareMap.get(DcMotorEx::class.java, PARAMS.rightBackName)
        rightFront = hardwareMap.get(DcMotorEx::class.java, PARAMS.rightFrontName)
        ...
        leftFront.direction = PARAMS.leftFrontDirection
        leftBack.direction = PARAMS.leftBackDirection
        rightFront.direction = PARAMS.rightFrontDirection
        rightBack.direction = PARAMS.rightBackDirection
    ...
    companion object {
        @JvmField
        var PARAMS: MecanumDriveConstants = MecanumDriveConstants
    }
}
